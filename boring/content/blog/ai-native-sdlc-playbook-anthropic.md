---
title: "从 intent.md 到闭环：AI 原生软件开发的六个阶段、一条产物链、几道审批门"
date: 2026-09-02
update_date: 2026-09-02
description: "解读 Anthropic《AI 原生 SDLC 手册》：从 intent.md 到闭环的六个阶段、一条产物链、几道审批门，重新定义受监管企业如何在 agent 时代落地 Claude Code。"
tldr: "AI 原生 SDLC 不是把流程取消掉，而是把旧的控制目标翻译成新的执行机制——产物链、门、hook、eval、闭环。"
taxonomies:
